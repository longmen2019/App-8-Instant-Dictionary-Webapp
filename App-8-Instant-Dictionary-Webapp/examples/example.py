...
def home():
    ...
    jp.Div(a=div1, text="Just another div...", classes="text-grey-600")
    jp.Div(a=div1, text="Yet another div...", classes="text-grey-600")
    ...
    jp.Div(a=div2, text="I am a cool interactive div!", mouseenter=mouse_enter, mouseleave=mouse_leave,
